<div id="comment-{{ $comment->id }}" class="row my-4">
    ...
    <div class="col-2">
        <img src="{{ $comment->user->image_url }}" alt="user image" class="img-fluid rounded-circle img-sm">
    </div>
    ...
    <div class="col-auto align-self-center ml-auto p-0">
        <div class="dropdown show">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="post-manage">
                <a class="dropdown-item text-right comment-edit-button" data-id="{{ $comment->id }}">Edit<i class="fa fa-edit ml-2"></i></a>
                <a class="dropdown-item text-right comment-delete-button" data-id="{{ $comment->id }}">Delete<i class="fas fa-trash ml-2"></i></a>
            </div>
        </div>
    </div>
    @endcan
