...
<div id="smallNav" class="container-fluid d-block d-lg-none sticky-top bg-dark py-2">
    <div class="row">
        <div class="col-3 d-flex justify-content-center align-items-center">
            <a href="<?php echo e(route('logout')); ?>"><i class="fa fa-sign-out-alt"></i> <span class="d-none d-md-inline">Logout</span></a>
        </div>
    </div>
    <div class="row mt-3">
        ...
        <div class="col-3 text-center">
            <a href="<?php echo e(route('profile-show', auth()->user())); ?>"><img src="<?php echo e(auth()->user()->image_url); ?>" class="img-fluid rounded-circle img-xs"></a>
        </div>
    </div>
</div>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top d-none d-lg-block" id="mainNav">
    <div class="container my-1">
        <a class="navbar-brand" href="<?php echo e(route('home')); ?>"><?php echo e(config('app.name', 'Ubuntu Social')); ?></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a href="<?php echo e(route('profile-show', auth()->user())); ?>" class="nav-link pr-md-0"><img src="<?php echo e(auth()->user()->image_url); ?>" class="img-fluid rounded-circle img-xs mr-2"><?php echo e(auth()->user()->name); ?></a>
                </li>

                <li class="d-none d-md-flex align-items-center"><span class="vertical-divider mx-3"></span></li>

                <li class="nav-item">
                    <a href="<?php echo e(route('home')); ?>" class="nav-link pl-md-0">Home</a>
                </li>
